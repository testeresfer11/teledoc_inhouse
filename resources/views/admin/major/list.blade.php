      ...
      <div class="card">
        ...
        <h4 class="card-title">Majors Management</h4>
          ...
          <div class="d-flex justify-content-between">
              ...
              <a href="{{route('admin.major.add')}}"><button type="button" class="btn default-btn btn-md">
                <span class="menu-icon">+ Add Majors</span></button></a>
          </div>
                  ...
                  <tr data-id="{{$data->id}}">
                    ...
                    <td> 
                      <span class="menu-icon">
                        <a href="{{route('admin.major.edit',['id' => $data->id])}}" title="Edit" class="text-success"><i class="mdi mdi-pencil"></i></a>
                      </span>&nbsp;&nbsp;
                      <span class="menu-icon">
    ...
    var category_id =  $(this).data('id');
      Swal.fire({
          ...
          if (result.isConfirmed) {
              $.ajax({
                  url: "/admin/major/delete/" + category_id,
                  type: "GET", 
