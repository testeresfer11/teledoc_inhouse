      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" id="add-user" action="{{route('admin.doctor.add')}}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-6 select_country_code">
                        ...
                        <input type="hidden" name="country_code" value="233">
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-6">
                        <label for="education">About Dr.</label>
                        <textarea class="form-control @error('about_dr') is-invalid @enderror" id="about_dr" placeholder="About Dr." name = "about_dr" cols="3" rows="3"></textarea>
                        @error('education')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        <div class="row">                    
                            <div class="col-6 chat-fees">
                                ...
                                <input type="number" name="is_first_time" class="form-control" placeholder="GHS"><br>
                                <label for="follow-up">Follow Up</label>
                                <input type="number" name="is_first_time" class="form-control" placeholder="GHS">
                            </div>
