              ...
              <tbody>
                @forelse ($doctors as $user)
                  <tr data-id="{{$user->id}}">
                    ...
                    <td>
                      @if($user->questionResponse()->count())
                        <a href="{{route('admin.user.response.list',['user_id' => $user->id])}}">{{$user->questionResponse()->count()}}</a>
                      @else
                        0
                      @endif
                    </td>
                    ...
                    <td> 
                      @if($user->plan_type == "basic")
                        <span class="menu-icon">
                          <a href="#" title="User Subscription" class="text-info changeUserSubscription" data-id="{{$user->id}}"><i class="mdi mdi-playlist-check"></i></a>
                        </span> &nbsp;&nbsp;&nbsp;
                      @endif
                      <span class="menu-icon">
