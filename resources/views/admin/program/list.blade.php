      ...
      <div class="card">
        ...
        <h4 class="card-title">Program Management</h4>
          ...
          <div class="d-flex justify-content-between">
              ...
              <a href="{{route('admin.program.add')}}"><button type="button" class="btn default-btn btn-md">
                <span class="menu-icon">+ Add Program</span></button></a>
          </div>
                  ...
                  <tr data-id="{{$data->id}}">
                    ...
                    <td> 
                      <span class="menu-icon">
                        <a href="{{route('admin.program.edit',['id' => $data->id])}}" title="Edit" class="text-success"><i class="mdi mdi-pencil"></i></a>
                      </span>&nbsp;&nbsp;
                      <span class="menu-icon">
...
<script>
  $('.deleteCategory').on('click', function() {
    var category_id =  $(this).data('id');
      Swal.fire({
          title: "Are you sure?",
          text: "You want to delete the Program?",
          icon: "warning",
          ...
          if (result.isConfirmed) {
              $.ajax({
                  url: "/admin/program/delete/" + category_id,
                  type: "GET", 
  ...
  $('.switch').on('click', function() {
    ...
    Swal.fire({
        title: "Are you sure?",
        text: "Do you want to change the status of the Program?",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#2ea57c",
        cancelButtonColor: "#d33",
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "/admin/program/changeStatus",
                type: "GET",
